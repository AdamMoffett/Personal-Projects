# expanding the list of items the calculator handles
# adjusted size of text boxes to accomadate for additional items
...
def main():
    ...
    window = tk.Tk()
    window.title("Pathfinder Ammo Calculator v0.1.0")
